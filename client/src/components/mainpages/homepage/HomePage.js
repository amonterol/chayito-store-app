...
export default function Home() {
  ...
  const [featuredWomenProducts] = state.productsAPI.featuredWomenProducts;
  const [featuredMenProducts] = state.productsAPI.featuredMenProducts;
  ...
  return (
    <main>
      ...
      <section className="upper-container">
        <div className="fila1">
          <Link id="btn_view" to={`/products/women`}>
            <img
        ...
        <div className="fila1">
          <Link id="btn_view" to={`/products/men`}>
            <img
